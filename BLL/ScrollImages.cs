...
namespace ClassLibrary.BLL
{
    ...
    public class ScrollImages
    {
        ...
        /// 数据操作实例
        /// </summary>
        private readonly ClassLibrary.DAL.ScrollImages dal = new ClassLibrary.DAL.ScrollImages();
        ...
        public List<ClassLibrary.Model.ScrollImages> GetModelList(string strWhere)
        {
            DataTable dt = GetData(strWhere);
            List<ClassLibrary.Model.ScrollImages> modelList = new List<ClassLibrary.Model.ScrollImages>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                ClassLibrary.Model.ScrollImages model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new ClassLibrary.Model.ScrollImages();
        ...
        /// <param name="strWhere">条件</param>
        /// <returns>ScrollImages集合</returns>
        public List<ClassLibrary.Model.ScrollImages> GetModelList(string strWhere, string orderBy)
        {
