...
namespace ClassLibrary.DAL
{
    ...
    public class SystemArticle
    {
        ...
        /// 表名
        /// </summary>
		private static readonly string table = "SystemArticle";
		/// <summary>
        /// 主键列
        /// </summary>
        ...
        {
            return SQLHelper.GetData("ID,classID,Title,Content,CreatedTime", table, strWhere, getOrder(orderBy));
        }
        ...
        public DataSet GetPageData(int pageSize, int pageNum, string strWhere, string orderBy)
        {
            return SQLHelper.GetPageData(pageSize, pageNum
                    , "ID,classID,Title,Content,CreatedTime"
                    , table
