...
namespace ClassLibrary.DAL
{
    ...
    public class Admin
    {
        ...
        /// 表名
        /// </summary>
		private static readonly string table = "Admin";
		/// <summary>
        /// 主键列
        /// </summary>
        ...
        {
            return SQLHelper.GetData("ID,UserName,Password,Power,CreatedTime", table, strWhere, getOrder(orderBy));
        }
        ...
        public DataSet GetPageData(int pageSize, int pageNum, string strWhere, string orderBy)
        {
            return SQLHelper.GetPageData(pageSize, pageNum
                    , "ID,UserName,Password,Power,CreatedTime"
                    , table
