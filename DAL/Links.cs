...
namespace ClassLibrary.DAL
{
    ...
    public class Links
    {
        ...
        /// 表名
        /// </summary>
		private static readonly string table = "Links";
		/// <summary>
        /// 主键列
        /// </summary>
        ...
        {
            return SQLHelper.GetData("ID,Title,Img,LinkURL,CreatedTime,LinkClass", table, strWhere, getOrder(orderBy));
        }
        ...
        {
            string sql = "ID,Title,Img,LinkURL,CreatedTime,LinkClass";
        ...
        public DataSet GetPageData(int pageSize, int pageNum, string strWhere, string orderBy)
        {
            return SQLHelper.GetPageData(pageSize, pageNum
                    , "ID,Title,Img,LinkURL,CreatedTime,LinkClass"
                    , table
