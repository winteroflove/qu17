...
{
    public partial class ScrollImageEdit : System.Web.UI.Page
    {
        ...
        private void GetArgument()
        {
            ...
            {
                Function.goMessagePage("修改首页图片", "操作失败，参数错误!", "Advertise/ScrollImageList.aspx");
            }
        }
        ...
        private void BindData()
        {
            ...
            {
                Function.goMessagePage("修改首页图片", "操作失败，数据不存在!", "Advertise/ScrollImageList.aspx");
            }
        ...
        private void EditLink()
        {
            ...
            {
                Function.goMessagePage("修改首页图片", "操作成功", "Advertise/ScrollImageList.aspx");
            }
            else
            {
                Function.goMessagePage("修改首页图片", "操作失败，请稍后再试", "Advertise/ScrollImageList.aspx");
            }
