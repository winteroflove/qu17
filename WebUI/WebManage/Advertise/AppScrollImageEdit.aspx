<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppScrollImageEdit.aspx.cs" Inherits="WebUI.WebManage.Advertise.AppScrollImageEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>编辑移动首页图片</title>
...
<body>
    <h1>
        <span><b>编辑首页图片</b></span><a href="AppScrollImageList.aspx">首页图片列表</a>
    </h1>
    <form class="form-div" action="AppScrollImageEdit.aspx?ac=edit" 
