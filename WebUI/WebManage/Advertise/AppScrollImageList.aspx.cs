...
{
    public partial class AppScrollImageList : System.Web.UI.Page
    {
        int pageSize = 20;
        int pageIndex;
        ...
        private void BindData()
        {
            ...
            foreach (DataRow dr in myTable.Rows)
            {
                ...
                sb.AppendFormat("<a href='AppScrollImageEdit.aspx?id={0}'>修改</a>　", dr["ID"].ToString());
                sb.AppendFormat("<a href='javascript:void(0)' onclick='appScrollImageDelete({0},\"{1}\")'>删除</a>", dr["ID"].ToString(),dr["Img"].ToString());
                sb.Append("</td>");
