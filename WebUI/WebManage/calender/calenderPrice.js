...
//===========输出日历===========
      ...
      str += "<tr><td id='cal_title' colspan='7' style='width:100%;height:25px;line-height:25px;' >"
      ...
      str += "</td></tr>";
      str += "<tr id='week'><td>星期日</td><td>星期一</td><td>星期二</td><td>星期三</td><td>星期四</td><td>星期五</td><td>星期六</td></tr>";
      str += "<tr>";
