<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinksAdd.aspx.cs" Inherits="WebUI.WebManage.Links.LinksAdd" %>
...
<body>
    <h1>
        <a href="LinksList.aspx">友情链接列表</a><span><b>添加友情链接</b></span>
    </h1>
    <form class="form-div" action="LinksAdd.aspx?ac=add" enctype="multipart/form-data"
    method="post">
