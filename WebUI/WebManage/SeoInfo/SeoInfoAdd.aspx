<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeoInfoAdd.aspx.cs" Inherits="WebUI.WebManage.SeoInfo.SeoInfoAdd" %>
...
<body>
    <h1>
        <a href="SeoInfoList.aspx">SEO信息列表</a><span><b>添加SEO信息</b></span>
    </h1>
    <form class="form-div" action="SeoInfoAdd.aspx?ac=add" enctype="multipart/form-data" method="post" onsubmit="return formSeoInfo(this)">
    <table width="100%" class="tableAdd">
        ...
        <tr>
            ...
            <td>
                <input type="text" size="90" maxlength="80" name="SeoTitle" />
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <textarea name="SeoKeywords" rows="4" cols="70"></textarea>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <textarea name="SeoDescription" rows="4" cols="70"></textarea>
            </td>
        </tr>
        <tfoot>
            <tr>
