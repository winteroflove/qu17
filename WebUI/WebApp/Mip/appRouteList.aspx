<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Mip/MipAppMain.Master" AutoEventWireup="true" CodeBehind="appRouteList.aspx.cs" Inherits="WebUI.WebApp.Mip.appRouteList" ValidateRequest="false" %>
...
.list_items li { float:left; margin-bottom:10px; height:30px; line-height:30px;margin-right:2%;}
.list_items li a { display:block; text-align:center; color:#7fb826; font-size:14px;}
...
.pageinfo { width:100%; height:30px; text-align:center;padding-bottom: 5px; padding-top:5px;}
...
<asp:Content ID="carticle" ContentPlaceHolderID="article" runat="server">
    <div class="article_box2">
        ...
        <div class="list_item_top">
            <div class="item_top_txt"><%=displayName %>旅游线路</div>
        </div>
